      ...
      <div class="footer_row">
        <div class="row news_row">
          ...
          <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            ...
            <?php
            // 注文票を書く: 「ニュースカテゴリーの記事を、日付の新しい順に、3件だけ欲しい」
              $args = array(
                'posts_per_page' => 3,// 1ページに表示する投稿数
                'category_name' => 'news',// カテゴリー名
                'orderby' => 'date',// 日付で並び替え
                'order' => 'DESC', // 降順で表示
                'post_type' => 'post',// 投稿タイプ
              );
              // 注文する: キッチン（WordPress）にその注文票を渡す
              $news_query = new WP_Query( $args );
              // もし記事があったら → 1つずつお皿（HTML）に乗せてテーブルに出す(while以下でループ処理の実行)
            ...
            <!-- <div class="news_simple_row">
              <div class="news_simple_date"><?php echo get_the_date('Y.m.d'); ?></div>
              <div class="news_simple_title">
                    ...
                    <div class="calendar_border">
                      <div class="calendar_border_1">
                        <div class="calendar_month">
                           <?php echo esc_html(get_post_meta(get_the_ID(), 'month', true)); ?>
                        </div>
                        <div class="calendar_day">
                          <span><?php echo esc_html(get_post_meta(get_the_ID(), 'day', true)); ?></span>
                        </div>
                      </div>
                    </div>
                  </div>
